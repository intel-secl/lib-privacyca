# Intel® Security Libraries for Data Center (Intel® SecL - DC) – Privacy CA Library
...
## Key features
- Provides functionalities for managing Endorsement and AIK Certificate
...
## Build Privacy CA Library

- Git clone the `Privacy CA Library`
- Run scripts to build the `Privacy CA Library`

```shell
$ git clone https://github.com/intel-secl/lib-privacyca.git
$ cd lib-privacyca
$ ant
```
